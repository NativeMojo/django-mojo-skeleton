...
#
# With options:
#   HOSTNAME=myapp.example.com REMOVE_SSM=y curl -fsSL .../ec2_django_mojo_install.sh | sudo bash
#
...
curl -fsSL https://gist.githubusercontent.com/istarnes/5c38558f57e659a87a8764f9efcf48ae/raw \
...
dnf install -y \
    ...
    postgresql17 postgresql17-server-devel \
